...
import {
  ...
  useFocusGuards,
  useId
} from "./chunk-UB4ZSXKA.js";
import "./chunk-Y4WL2V2M.js";
import {
  VISUALLY_HIDDEN_STYLES,
  createCollection
} from "./chunk-JGVDVH5Y.js";
import {
  DismissableLayer,
  Portal,
  Primitive,
...
var Select = (props) => {
  ...
  const [valueNode, setValueNode] = React8.useState(null);
  const [valueNodeHasChildren, setValueNodeHasChildren] = React8.useState(false);
  ...
  const triggerPointerDownPosRef = React8.useRef(null);
  const isFormControl = trigger ? form || !!trigger.closest("form") : true;
  const [nativeOptionsSet, setNativeOptionsSet] = React8.useState(/* @__PURE__ */ new Set());
      ...
      children: [
        (0, import_jsx_runtime5.jsx)(Collection.Provider, { scope: __scopeSelect, children: (0, import_jsx_runtime5.jsx)(
          SelectNativeOptionsProvider,
          {
            ...
            onNativeOptionAdd: React8.useCallback((option) => {
              setNativeOptionsSet((prev) => new Set(prev).add(option));
            }, []),
            onNativeOptionRemove: React8.useCallback((option) => {
...
var SelectTrigger = React8.forwardRef(
  (props, forwardedRef) => {
    ...
    const pointerTypeRef = React8.useRef("touch");
...
var SelectValue = React8.forwardRef(
  (props, forwardedRef) => {
...
var SelectIcon = React8.forwardRef(
  (props, forwardedRef) => {
...
var SelectContent = React8.forwardRef(
  (props, forwardedRef) => {
    ...
    const [fragment, setFragment] = React8.useState();
    useLayoutEffect2(() => {
...
var SelectContentImpl = React8.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeSelect,
    ...
    const composedRefs = useComposedRefs(forwardedRef, (node) => setContent(node));
    const [selectedItem, setSelectedItem] = React8.useState(null);
    const [selectedItemText, setSelectedItemText] = React8.useState(
      null
    );
    const getItems = useCollection(__scopeSelect);
    const [isPositioned, setIsPositioned] = React8.useState(false);
    const firstValidItemFoundRef = React8.useRef(false);
    React8.useEffect(() => {
      if (content) return hideOthers(content);
    }, [content]);
    useFocusGuards();
    const focusFirst = React8.useCallback(
      (candidates) => {
    ...
    const focusSelectedItem = React8.useCallback(
    ...
    const itemRefCallback = React8.useCallback(
      (node, value, disabled) => {
    ...
    const handleItemLeave = React8.useCallback(() => content == null ? void 0 : content.focus(), [content]);
    const itemTextRefCallback = React8.useCallback(
      (node, value, disabled) => {
        const isFirstValidItem = !firstValidItemFoundRef.current && !disabled;
        const isSelectedItem = context.value !== void 0 && context.value === value;
        if (isSelectedItem || isFirstValidItem) {
...
var SelectItemAlignedPosition = React8.forwardRef((props, forwardedRef) => {
  const { __scopeSelect, onPlaced, ...popperProps } = props;
  const context = useSelectContext(CONTENT_NAME2, __scopeSelect);
  const contentContext = useSelectContentContext(CONTENT_NAME2, __scopeSelect);
  const [contentWrapper, setContentWrapper] = React8.useState(null);
  const [content, setContent] = React8.useState(null);
  const composedRefs = useComposedRefs(forwardedRef, (node) => setContent(node));
  const getItems = useCollection(__scopeSelect);
  const shouldExpandOnScrollRef = React8.useRef(false);
  const shouldRepositionRef = React8.useRef(true);
  const { viewport, selectedItem, selectedItemText, focusSelectedItem } = contentContext;
  const position = React8.useCallback(() => {
  ...
  const handleScrollButtonChange = React8.useCallback(
    (node) => {
...
var SelectPopperPosition = React8.forwardRef((props, forwardedRef) => {
  const {
    __scopeSelect,
    align = "start",
...
var SelectViewport = React8.forwardRef(
  (props, forwardedRef) => {
    const { __scopeSelect, nonce, ...viewportProps } = props;
    const contentContext = useSelectContentContext(VIEWPORT_NAME, __scopeSelect);
    const viewportContext = useSelectViewportContext(VIEWPORT_NAME, __scopeSelect);
    const composedRefs = useComposedRefs(forwardedRef, contentContext.onViewportChange);
    const prevScrollTopRef = React8.useRef(0);
...
var SelectItem = React8.forwardRef(
  (props, forwardedRef) => {
    ...
    const [textValue, setTextValue] = React8.useState(textValueProp ?? "");
    ...
    return (0, import_jsx_runtime5.jsx)(
      SelectItemContextProvider,
      {
        ...
        textId,
        isSelected,
        onItemTextChange: React8.useCallback((node) => {
...
var SelectItemText = React8.forwardRef(
  (props, forwardedRef) => {
    ...
    const [itemTextNode, setItemTextNode] = React8.useState(null);
    const composedRefs = useComposedRefs(
      forwardedRef,
    ...
    const nativeOption = React8.useMemo(
...
var SelectItemIndicator = React8.forwardRef(
  (props, forwardedRef) => {
...
var SelectScrollUpButton = React8.forwardRef((props, forwardedRef) => {
  const contentContext = useSelectContentContext(SCROLL_UP_BUTTON_NAME, props.__scopeSelect);
  const viewportContext = useSelectViewportContext(SCROLL_UP_BUTTON_NAME, props.__scopeSelect);
  const [canScrollUp, setCanScrollUp] = React8.useState(false);
...
var SelectScrollDownButton = React8.forwardRef((props, forwardedRef) => {
  const contentContext = useSelectContentContext(SCROLL_DOWN_BUTTON_NAME, props.__scopeSelect);
  const viewportContext = useSelectViewportContext(SCROLL_DOWN_BUTTON_NAME, props.__scopeSelect);
  const [canScrollDown, setCanScrollDown] = React8.useState(false);
  const composedRefs = useComposedRefs(forwardedRef, viewportContext.onScrollButtonChange);
  useLayoutEffect2(() => {
    if (contentContext.viewport && contentContext.isPositioned) {
      let handleScroll2 = function() {
...
var SelectScrollButtonImpl = React8.forwardRef((props, forwardedRef) => {
  const { __scopeSelect, onAutoScroll, ...scrollIndicatorProps } = props;
  const contentContext = useSelectContentContext("SelectScrollButton", __scopeSelect);
  const autoScrollTimerRef = React8.useRef(null);
  const getItems = useCollection(__scopeSelect);
  const clearAutoScrollTimer = React8.useCallback(() => {
...
var SelectArrow = React8.forwardRef(
  (props, forwardedRef) => {
...
var SelectBubbleInput = React8.forwardRef(
...
function useTypeaheadSearch(onSearchChange) {
  ...
  const handleTypeaheadSearch = React8.useCallback(
    (key) => {
  ...
  const resetTypeahead = React8.useCallback(() => {
    searchRef.current = "";
    window.clearTimeout(timerRef.current);
  }, []);
  React8.useEffect(() => {
